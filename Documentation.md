...
```lua
local Window = HoneyLibrary:MakeWindow({Name = "Title of the library", HidePremium = false, SaveConfig = true, ConfigFolder = "OrionTest"})
...
print(HoneyLibrary.Flags["toggle"].Value) -- prints the value of the toggle.
```
